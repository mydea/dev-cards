 ...
 */
export function validateGameState(scoreData: SubmitScore): { valid: boolean; reason?: string } {
  ...
  if (scoreData.cards_played.length < scoreData.rounds) {
    return { valid: false, reason: 'Not enough cards played for number of rounds' };
  }
